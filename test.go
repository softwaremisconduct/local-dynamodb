...
func main() {
	...
	params := &dynamodb.CreateTableInput{
		AttributeDefinitions: []*dynamodb.AttributeDefinition{ // Required
			...
			{ // Required
				AttributeName: aws.String("weight"), // Required
				AttributeType: aws.String("N"),      // Required
			},
			{ // Required
				AttributeName: aws.String("height"), // Required
				AttributeType: aws.String("N"),      // Required
			},
			{ // Required
				AttributeName: aws.String("password"), // Required
				AttributeType: aws.String("S"),        // Required
			},
			{ // Required
				AttributeName: aws.String("membership"), // Required
				AttributeType: aws.String("S"),          // Required
			},
			{ // Required
